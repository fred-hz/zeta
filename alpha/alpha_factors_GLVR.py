...
#self.alpha[ii] = self.DebtEquityRatio[di-self.delay][ii]
                self.alpha[ii] = -self.GainLossVarianceRatio20[di-self.delay][ii]/self.GainLossVarianceRatio60[di-self.delay][ii]
