            ...
            if self.is_valid[di][ii]:
                ...
                for i in range(5):
                    if self.high[di-self.delay-i][ii]+self.low[di-self.delay-i][ii]+self.cps[di-self.delay-i][ii] > self.high[di-self.delay-i-1][ii]+self.low[di-self.delay-i-1][ii]+self.cps[di-self.delay-i-1][ii]:
                        temp[i] = (self.high[di-self.delay-i][ii]+self.low[di-self.delay-i][ii]+self.cps[di-self.delay-i][ii]) * self.vol[di-self.delay-i][ii] * (self.vol[di-self.delay-i][ii] - self.vol[di-self.delay-i-1][ii])
