...
class DataManagerUniverse(DataManagerBase):
    ...
    def provide_data(self):
        di_size = len(self.context.di_list) + 1
    ...
    def compute_day(self, di):
        if di != len(self.context.di_list):
            print('Begin calculate universe: ' + self.di_list[di])
        else:
            print('Begin calculate universe: next trading day')
        liquidity = {}
